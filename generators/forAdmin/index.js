...
module.exports = {
  ...
  actions: function(data) {
    ...
    if (data.name) {
      ...
      actions.push({
        type: 'append',
        path: rootExeDir + adminSrcPath + 'rootReducer.ts',
      ...
      actions.push({
        ...
        template: '  {{camelCase name}}: \'' + processSlash(data.routePath) + '\',',
        abortOnFail: true,
      });
      ...
      actions.push({
        ...
        path: rootExeDir + adminSrcPath + 'App.tsx',
        pattern: REGEX.IMPORT_PLOT,
        template: 'import {{properCase name}} from \'./containers/{{properCase name}}/Loadable\';',
        unique: true,
        abortOnFail: true,
      });
      // Create the saga
      ...
      actions.push({
        type: 'append',
        path: rootExeDir + adminSrcPath + 'rootSaga.ts',
        pattern: REGEX.IMPORT_PLOT,
